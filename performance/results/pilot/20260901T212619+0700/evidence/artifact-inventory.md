...
|---|---:|---|---|---|---|
| `raw/pilot-raw.json` | 13,045,547,159 | 2026-09-01 21:38:42 | `35a8835c07496704200e16270d7387bd5770b0acf94bf4bc70411064fe341736` | k6 native granular JSON output (`--out json=...`) | Never staged; removed 2026-09-01 22:13:05 +07 after human-approved preservation in `c75b514` |
| `raw/pilot-timeseries.csv` | 5,984,776,809 | 2026-09-01 21:37:56 | `c40a93c380f01ab73b4ce3e4043432838b9ab5306cc327ad8caf5fb425b6a5ce` | k6 native CSV output (`--out csv=...`) | Never staged; removed 2026-09-01 22:13:05 +07 after human-approved preservation in `c75b514` |
| `logs/k6.stderr.log` | 4,161,202,188 | 2026-09-01 21:37:55 | `59a75aaaa9b3368d310f2637998c56448afcb28f9b1feca4a772f6204310006e` | stderr redirection from the k6 process | Never staged; removed 2026-09-01 22:13:05 +07 after human-approved preservation in `c75b514` |
...
`SHA256SUMS` contains hashes of all original files above. At the time the
pre-deletion preservation record was committed as `c75b514`, all three remained
at their exact paths and had not been compressed, renamed, substituted, or
committed. They were then removed exactly as authorized. Filesystem free space
increased by 22,674,988 KiB (about 21.62 GiB); all three exact-path absence
checks passed.
...
HTTP. Only these three exact untracked files were removed after this evidence

...
| AI critique (H-021) | Produce an evidence-grounded 200–300 word candidate | Official execution history is complete; critique drafting follows the current analysis/optimization verdict gate | Final substantive critique requires student review/approval | Edit or explicitly approve the later draft | PENDING HUMAN REVIEW |

...
| Endurance visual evidence (H-012) | Capture genuine k6 execution and exact backend PID together | Fresh preflight `20260902T143823+0700` passes; backend PID `53376`; no k6 traffic/result yet | It must show the real steady 5-VU endurance run, not another scenario | Filter Activity Monitor to PID `53376`, arrange beside terminal, reply `READY`, capture during the middle of the 12-minute hold | PENDING HUMAN REVIEW |

...
| Official Spike visual evidence (H-012) | Capture real Spike peak and exact disposable backend resource usage together | Spike preflight `20260902T104549+0700` passed; backend PID `48405`; no traffic/screenshot yet | Peak rise/hold is only 10s/45s, so framing must be ready before start | Filter Activity Monitor to PID `48405`, arrange beside live Spike output, reply `READY`, capture during 20-VU hold | PENDING HUMAN REVIEW |

...
| Official Stress visual evidence (H-012) | Capture real Stress execution and exact disposable backend resource usage together | Stress preflight `20260902T101857+0700` passed; exact backend PID is `45430`; measured traffic/screenshot have not started | Headless automation cannot guarantee genuine combined GUI evidence | Filter Activity Monitor to PID `45430`, arrange beside live Stress output, reply `READY`, and capture during a high stage (preferably 20-VU hold) | PENDING HUMAN REVIEW |
| Later Spike/endurance visual evidence (H-012) | Repeat genuine combined tool/backend-resource capture for each fresh run | Those runtimes/PIDs do not exist yet | Each run needs its own real process and screenshot | Follow the later immediate pre-traffic gate instructions | PENDING HUMAN REVIEW |

...
- [ ] Show k6/tool and the relevant backend Activity Monitor view in the same
      frame; use existing genuine evidence or a clearly labeled fresh demo run.
- [ ] Demonstrate the submitted Agent Skill end-to-end on the evidence tree.
